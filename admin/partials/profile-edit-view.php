				...
				<thead>
					<tr>
						...
						<th class="ced_catch_profile_heading ced_catch_settings_heading">
							<label class="basic_heading"><?php esc_attr_e( 'BASIC DETAILS', 'woocommerce-catch-integration' ); ?></label>
						</th>
					</tr>
				</thead>
				<tbody>		
					<tr>
						...
						if ( isset( $profile_data['profile_name'] ) ) {
							...
							?>
							<td>
								<label><b><?php echo esc_attr( ucwords( $profile_data['profile_name'] ) ); ?></b></label>
							</td>
						</tr>
							<?php
						} else {
						...
						<td data-catlevel="1" id="ced_catch_categories_in_profile">
							<select class="ced_catch_select_category_on_add_profile select2 ced_catch_select2 ced_catch_level1_category"  name="ced_catch_level1_category[]" data-level=1 data-catchStoreId="<?php echo esc_attr( $shop_id ); ?>">
								<option value=""><?php esc_attr_e( '--Select--', 'woocommerce-catch-integration' ); ?></option>
								<?php
						...
						<td><a><?php esc_attr_e( '( Please Select Profile Name )', 'woocommerce-catch-integration' ); ?></a></td>
							<?php
						}
					...
					<tr>
						...
						if ( '' != $profileID && ! empty( $categorySpecifics ) ) {
							?>
							<th  class="ced_catch_profile_heading ced_catch_settings_heading">
								<label class="basic_heading"><?php esc_attr_e( 'CATEGORY SPECIFIC', 'woocommerce-catch-integration' ); ?></label>
							</th>
