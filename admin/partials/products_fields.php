...
if ( ! class_exists( 'CedCatchProductsFields' ) ) {
	...
	class CedCatchProductsFields {
		 ...
		 */
		public function renderDropdownHTML( $attribute_id, $attribute_name, $values, $categoryID, $productID, $marketPlace, $attribute_description = null, $indexToUse = 0, $additionalInfo = array( 'case' => 'product' ), $is_required = '' ) {
		...
		public function renderDropdownHTMLForCategorySpecifics( $attribute_id, $attribute_name, $values, $categoryID, $productID, $marketPlace, $attribute_description = null, $indexToUse = 0, $additionalInfo = array( 'case' => 'product' ), $is_required = '' ) {
				$fieldName = 'ced_catch_custom_' . $attribute_id;
		 ...
		 */
		public function renderInputTextHTML( $attribute_id, $attribute_name, $categoryID, $productID, $marketPlace, $attribute_description = null, $indexToUse = 0, $additionalInfo = array( 'case' => 'product' ), $conditionally_required = false, $conditionally_required_text = '', $valueType = '', $input_type = '' ) {
		 ...
		 */
		public function renderInputTextHTMLhidden( $attribute_id, $attribute_name, $categoryID, $productID, $marketPlace, $attribute_description = null, $indexToUse = 0, $additionalInfo = array( 'case' => 'product' ), $conditionally_required = false, $conditionally_required_text = '' ) {
			global $post,$product,$loop;
